...
<head>
    ...
    <link href="{{asset('frontend/css/animate.cs')}}s" rel="stylesheet">
						...
						<div class="carousel-inner">
							...
							<div class="item active">
							 ...
							 ?>
								...
								<div class="col-sm-6">
									<img src="{{URL::to($single_slider->slider_image)}}" class="girl img-responsive" alt="" />
								...
								<ul class="nav nav-pills nav-stacked">
									@php
										...
										foreach ($all_manufacture as $single_manufacture) {
											@endphp
												<li><a href="{{('/product_by_manufacture/'.$single_manufacture->manufacture_id)}}"> <span class="pull-right">(4)</span>{{$single_manufacture->manufacture_name}}</a></li>
											@php
										}
									@endphp
