...
@section('admin_content')
	...
	<ul class="breadcrumb">
				...
				<p class="alert alert-success alert-dismissible">
						<?php
								$manufacturemsg = Session::get('manufacturemsg');
								if($manufacturemsg){
									echo $manufacturemsg;
									Session::put('manufacturemsg',null);
								}
							?>
						</p>
						<p class="alert alert-success alert-dismissible">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									@if ($v_manufacture->publication_status == 1)
										<a class="btn btn-success" href="{{URL::to('/manufacture_unactive/'.$v_manufacture->manufacture_id)}}">
										<i class="halflings-icon white thumbs-up"></i>  
									</a>
									@else
										<a class="btn btn-danger" href="{{('/manufacture_active/'.$v_manufacture->manufacture_id)}}">
